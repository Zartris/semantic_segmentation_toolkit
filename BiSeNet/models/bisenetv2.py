...
class CEBlock(nn.Module):  # Content Embedding block
...
class GELayerS1(nn.Module):  # Gather-and-Expansion Layer
...
class BGALayer(nn.Module):  # Bilateral Guided Aggregation
