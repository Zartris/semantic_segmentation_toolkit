...
from ptsemseg.schedulers.schedulers import WarmUpLR, ConstantLR, PolynomialLR, WarmupPolyLrScheduler

logger = logging.getLogger("ptsemseg")

key2scheduler = {
    "constant_lr": ConstantLR,
    "poly_lr": WarmupPolyLrScheduler,
    "multi_step": MultiStepLR,
    "cosine_annealing": CosineAnnealingLR,
    "exp_lr": ExponentialLR,
    "warmup_poly_lr": WarmupPolyLrScheduler
}


# def get_scheduler(optimizer, scheduler_dict, max_iterations=90000):
...
#     scheduler_dict["max_iter"] = max_iterations
