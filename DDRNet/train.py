...
def train(cfg, logger, logdir):
    ...
    # model.apply(weights_init) These are already applied by model
    ...
    while i <= cfg["training"]["train_iters"] and flag:
        ...
        for i_train_batch, (images, labels, _) in enumerate(trainloader):
            ...
            with amp.autocast(enabled=cfg['training']['use_fp16']):
                ...
                loss = loss_fn(input=outputs, target=labels)  # probs = torch.softmax(logits, dim=1)
                ...
                with torch.no_grad():
                    ...
                    for i_val, (images_val, labels_val, _) in tqdm(enumerate(valloader)):
                        ...
                        if h != ht and w != wt:  # upsample labels
                            ...
                            pred = scipy.ndimage.zoom(pred, (1, factor_h, factor_w), order=1)
